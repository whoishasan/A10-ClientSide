    ...
    <>
      <div className="border-x border-t rounded-t-xl w-full dark:border-border-1 px-3 py-2 flex flex-wrap gap-2">
        ...
        <button
          ...
          className={`bg-slate-200 hover:bg-slate-300 dark:bg-slate-800 hover:dark:bg-slate-600 px-2 rounded-sm ${
            !editor.isActive({ textAlign: "left" })
              ? "is-active"
              : "dark:!bg-[#0285c750] !bg-[#0285c78b] !text-white"
          }`}
        >
          <GrTextAlignLeft />
        </button>
  ...
  <button
    ...
    className={`bg-slate-200 hover:bg-slate-300 dark:bg-slate-800 hover:dark:bg-slate-600 px-2 rounded-sm ${
      !editor.isActive(type)
        ? "is-active"
        : "dark:!bg-[#0285c750] !bg-[#37ff599d] !text-white"
    }`}
  >
    {children}
  </button>
